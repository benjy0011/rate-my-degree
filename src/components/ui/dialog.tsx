...
function Dialog({
  ...
  const handleDialogClose = (isOpen: boolean) => {
    // Only close if not clicking on a toast
    if (!isOpen && document.querySelector('[data-sonner-toast]')) {
      return;
    }
    onOpenChange?.(isOpen);
  };

  return <DialogPrimitive.Root data-slot="dialog" {...props} onOpenChange={handleDialogClose} />
}
